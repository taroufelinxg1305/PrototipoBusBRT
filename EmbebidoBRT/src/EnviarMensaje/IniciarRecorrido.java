...
public class IniciarRecorrido {
	public static void iniciarPAM() {
		try {
			 URL obj = new URL("http://localhost:8080/cloudBRT/api/colector/parqueAutomotor/iniciar");
	...
	public static void iniciarReco() {
		try {
			 URL obj = new URL("http://localhost:8080/cloudBRT/api/colector/itinerario/iniciar/I3T3");
			    HttpURLConnection conn = (HttpURLConnection) obj.openConnection();
